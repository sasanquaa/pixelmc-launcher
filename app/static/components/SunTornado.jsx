...
export default function SunTornado(props) {
	return (
		<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 2000 1500">
			<rect fill="#222831" width="2000" height="1500" />
			<defs>
				<radialGradient id="a" gradientUnits="objectBoundingBox">
					<stop offset="0" stopColor="#393e46" />
					<stop offset="1" stopColor="#222831" />
				</radialGradient>
...
SunTornado.propTypes = {
	rotate: PropTypes.string
};

SunTornado.defaultProps = {
	rotate: "rotate(-79.2, 0, 0)"
};
